...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="status_form.php" enctype="multipart/form-data" method="post">
            <div class="row">
                <div class="col-xl-6">
                    <div id="panel-1" class="panel">
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <input type="hidden" id="simpleinput" class="form-control" value="<?php echo $user_data['id'];?>" name="id">
                                <div class="row">
                                    <div class="col-md-4">
                                        <!-- status -->
