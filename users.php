...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <?php echo $_SESSION['log-in'] ? '<a class="btn btn-success" href="create_user.php">Добавить</a>' : ''?>
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <a href="page_profile.php?id=<?php echo $user["id"];?>"><span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo has_image($user['avatar']) ?>'); background-size: cover;"></span></a>
                                </span>
                            ...
                            <div class="p-3">
                                ...
                                <div class="d-flex flex-row">
                                    <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#4680C2">
                                        <i class="fab fa-vk"><?php echo $user['vk'];?></i>
                                    </a>
                                    <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-telegram"><?php echo $user['telegram'];?></i>
                                    </a>
                                    <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#E1306C">
                                        <i class="fab fa-instagram"><?php echo $user['instagram'];?></i>
                                    </a>
                                </div>
                            </div>
                        </div>
